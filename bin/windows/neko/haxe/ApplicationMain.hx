...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("ildarkarymoff", "rgbho", "com.carrymove.rgbho", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (com.carrymove.rgbho.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (com.carrymove.rgbho.Main, Reflect.field (com.carrymove.rgbho.Main, "main"), []);
...
@:keep class DocumentClass extends com.carrymove.rgbho.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "rgb-ho", null, { width: 800, height: 480 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.carrymove.rgbho.Main, []);
			}
...
import com.carrymove.rgbho.Main;
