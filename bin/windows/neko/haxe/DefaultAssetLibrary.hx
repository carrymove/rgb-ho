...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__fonts_gothaproreg_otf);
...
@:keep #if display private #end class __ASSET__fonts_gothaproreg_otf extends flash.text.Font { #if (!openfl_html5_dom) public function new () { super (); fontName = "fonts/GothaProReg.otf"; } #end }
