...
@:keep @:bind #if display private #end class __ASSET__fonts_gothaproreg_otf extends null { }
...
#if openfl
class __ASSET__fonts_gothaproreg_otf extends openfl.text.Font { public function new () { super (); __fontPath = "fonts/GothaProReg"; fontName = "Gotham Pro"; }}
